...
const translations = {
  zh: {
    ...
    userCreateFail: '创建失败: ',
    userUpdateFail: '更新失败: ',
    userDeleteConfirm: (name) => `确定删除用户 ${name}？`,
    userDeleteFail: '删除失败: ',
    userPassword: '密码',
    userPasswordHint: '默认 123456',
    userDuplicate: '用户名已存在',

    // Attendance
    navAttendance: '打卡',
    attendanceTitle: '今日打卡',
    attendancePresent: '在场',
    attendanceLeave: '请假',
    attendanceAbsent: '缺勤',
    attendanceRest: '休息',
    attendanceNotRecorded: '未记录',
    attendanceDate: '日期',
    attendanceStatus: '状态',
    attendanceNote: '备注',
    attendanceSaved: '已保存',
    ...
    waTitle: 'WhatsApp 消息',
    waSchedule: '排班通知',
    waScheduleDesc: '自动生成本周排班',
    waAnnouncement: '公告通知',
    waAnnouncementDesc: '发送公告给员工',
    waCustom: '自定义消息',
    waCustomDesc: '自由编辑消息内容',
    waSelectAnnouncement: '选择公告',
    waCustomMessage: '消息内容',
    waCustomPlaceholder: '输入要发送的消息...',
    waPreview: '消息预览',
    waRecipients: '发送对象',
    waNoPhone: '无号码',
    waSelectAll: '全选',
    ...
    waNotConfigured: '未配置',
    waConfig: '配置',
    waConfigTitle: 'WhatsApp Business API 配置',
    waConfigHelp: '需要 Meta Business 开发者账号。在 developers.facebook.com 获取 Phone Number ID 和 Access Token。',
    waConfigRequired: '请先配置 WhatsApp API',
    ...
    profileConfirmPassword: '确认密码',
    profilePasswordMismatch: '两次密码不一致',
    profileSaveSuccess: '保存成功',
    profileSaveFail: '保存失败: ',
    profileAvatarSuccess: '头像已更新',
    profileAvatarFail: '头像上传失败: ',
  ...
  es: {
    ...
    hasContract: '✔ Sí',
    noContract: '✘ No',
    colToggle: 'Mostrar/ocultar columnas',
    ...
    userRoleStaff: 'Empleado',
    userStatus: 'Estado',
    userActive: 'Activo',
    userInactive: 'Inactivo',
    userCreateSuccess: 'Usuario creado',
    userCreateFail: 'Error al crear: ',
    userUpdateFail: 'Error al actualizar: ',
    userDeleteConfirm: (name) => `¿Eliminar usuario ${name}?`,
    userDeleteFail: 'Error al eliminar: ',
    userPassword: 'Contraseña',
    userPasswordHint: 'Por defecto 123456',
    userDuplicate: 'Usuario ya existe',

    // Attendance
    navAttendance: 'Asistencia',
    attendanceTitle: 'Asistencia de hoy',
    attendancePresent: 'Presente',
    attendanceLeave: 'Permiso',
    attendanceAbsent: 'Ausente',
    attendanceRest: 'Descanso',
    attendanceNotRecorded: 'Sin registro',
    attendanceDate: 'Fecha',
    attendanceStatus: 'Estado',
    attendanceNote: 'Nota',
    attendanceSaved: 'Guardado',
    attendanceFail: 'Error al guardar: ',
    attendanceWorking: 'Trabajando',
    attendanceToday: 'Hoy',

    // WhatsApp
    navWhatsApp: 'WhatsApp',
    waTitle: 'Mensajes WhatsApp',
    waSchedule: 'Horario',
    waScheduleDesc: 'Horario semanal automático',
    waAnnouncement: 'Aviso',
    waAnnouncementDesc: 'Enviar aviso a empleados',
    waCustom: 'Personalizado',
    waCustomDesc: 'Escribir mensaje libre',
    waSelectAnnouncement: 'Seleccionar aviso',
    waCustomMessage: 'Mensaje',
    waCustomPlaceholder: 'Escriba el mensaje...',
    waPreview: 'Vista previa',
    waRecipients: 'Destinatarios',
    waNoPhone: 'Sin teléfono',
    waSelectAll: 'Todos',
    waSelectNone: 'Ninguno',
    waAddPhone: '+ Agregar teléfono',
    waSend: 'Enviar',
    waSendAll: 'Enviar a todos',
    waSending: 'Enviando...',
    waSent: 'Enviado',
    waFailed: 'Error',
    waSentCount: 'Enviados',
    waFailedList: 'Falló el envío',
    waConnected: 'Conectado',
    waNotConfigured: 'No configurado',
    waConfig: 'Configurar',
    waConfigTitle: 'Configuración WhatsApp Business API',
    waConfigHelp: 'Necesitas una cuenta Meta Business. Obtén el Phone Number ID y Access Token en developers.facebook.com.',
    waConfigRequired: 'Configure la API de WhatsApp primero',
    ...
    profileSaveSuccess: 'Guardado exitosamente',
    profileSaveFail: 'Error al guardar: ',
    profileAvatarSuccess: 'Avatar actualizado',
    profileAvatarFail: 'Error al subir avatar: ',
    profileCreatedAt: 'Fecha de registro',
